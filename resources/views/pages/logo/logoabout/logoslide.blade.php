        ...
        <div class="col-lg-12 grid-margin stretch-card">
            ...
            <div class="card">
                ...
                <div class="card-header py-3">
                    สไลด์เกี่ยวกับองค์กร
                </div>
                <div class="py-2"  style="text-align:right;padding:3px;">
                    <a href="{{ route('logoabout.create') }}" class="btn btn-success">
                       เพิ่มสไลด์เกี่ยวกับองค์กร
                    </a>
                </div>
              <div class="card-body">
                  ...
                  <table id="myTable">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                            <a href="{{ url('/admin/logoabout/' . $items->id . '/edit') }}" class="btnx editmdi btn-edit"><i class="mdi mdi-brush"></i></a>
