        ...
        <div class="col-lg-6">
          <form action="#" method="post" role="form" class="php-email-form">
            ...
            <div class="form-group">
              <input type="text" class="form-control" name="subject" id="subject" placeholder="เบอร์โทร" required>
            </div>
            ...
            <div class="text-center">
                <button type="button" class="btn btn-danger"  onclick="save();">ส่งข้อความ</button>
            </div>
          </form>
        </div>
